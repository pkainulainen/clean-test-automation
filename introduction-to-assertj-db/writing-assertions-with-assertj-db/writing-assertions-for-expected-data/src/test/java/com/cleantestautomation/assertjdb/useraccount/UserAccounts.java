...
public class UserAccounts {
     ...
     * database table.
     */
    public static final UserAccountRow AnneOwens = UserAccountRow.getBuilder()
            .withId(1L)
     ...
     */
    public static final UserAccountRow UpdatedAnneOwens = UserAccountRow.getBuilder()
            .withId(1L)
            .withCreationTimeDb(TestDateTimeBuilder.transformUTCDateTimeToLocalDateTime("2023-05-09T10:46:00"))
     ...
     * database table.
     */
    public static final UserAccountRow LeoVirtanen = UserAccountRow.getBuilder()
            .withId(2L)
